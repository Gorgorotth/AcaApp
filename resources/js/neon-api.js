...
window.public_vars = window.public_vars || {};
...
window.show_sidebar_menu = function (with_animation)
{
	if(isxs())
		return;
...
window.hide_sidebar_menu = function (with_animation)
{
	if(isxs())
		return;
...
window.toggle_sidebar_menu = function (with_animation)
{
...
// Added on v1.5
window.rtl = function () // checks whether the content is in RTL mode
{
...
window.rb_hide_sidebar_menu = function (with_animation)
{		
	if( ! with_animation)
	{
		public_vars.$pageContainer.addClass(public_vars.sidebarCollapseClass);
...
window.rb_show_sidebar_menu = function (with_animation)
{	
	if( ! with_animation)
	{
		public_vars.$pageContainer.removeClass(public_vars.sidebarCollapseClass);
